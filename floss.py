...
class Floss:
    ...
    def get_txt_data(self, txt_file):
    ...
    def txt_service(self, data_path, output_path):
        ...
        * Retrieves data from file specified in txt_file, converts data to JSON,
        ...
        :param data_path: source of stock data
    ...
    def validate_arguments(self, stream_path, output_path):
    ...
    def read_file_stream(self, stream_path, output_path):
        ...
        while run:
            ...
            if file_size == 0:
            ...
            elif file_size != last_size and output_size == 0 and len(data_path) > 0:
                ...
                run = result
            elif output_size == 0 and len(data_path) > 0:
                # Output file is empty, write data to output
                last_size = file_size

                result = self.file_service(data_path, output_path)
                run = result
            elif file_size != last_size and output_size > 0:
    ...
    def main_loop(self):
        ...
        stream = self.read_file_stream(stream_path, output_path)
